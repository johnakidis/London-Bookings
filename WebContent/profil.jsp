...
ResultSet rs=statement.executeQuery("SELECT * FROM users WHERE username='"+cur+"' ");
if(rs.next()){
%>
<form id="ex" action="UpdateServlet" method="post" onsubmit="return sform(this)">
	<input type="text" placeholder="Username " name="usr" value="<%=rs.getString("username")%>" maxlength="20" required/>
	<input type="email" placeholder="Email" name="email" value="<%=rs.getString("email")%>" maxlength="20" required/>
	<input type="text" placeholder="First Name" value="<%=rs.getString("name")%>" name="nm" maxlength="20" required/>
	<input type="text" placeholder="Last Name" value="<%=rs.getString("surname")%>" name="snm" maxlength="20" required/>
	<input type="text" placeholder="Phone" name="phone" value="<%=rs.getString("phone")%>" maxlength="20" required />
	<input type="password" placeholder="Type old password or a new one" name="pwd" id="pass" minlength="5" maxlength="20" required/>
	<input type="password" placeholder="Re-type Password" name="pwd2" maxlength="20" minlength="5" id="repass" required/> <br/><br/>

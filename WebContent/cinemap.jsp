...
<div class="signupf">
<form action="CinemaSearch" id="ex" method="post" onsubmit="return sform(this)">
	...
	<a class="b5" href="cinema.jsp">Reset filters</a>
</form>
</div>
<div class="data">
<%
...
%>
<h2>No results found</h2> <a class="b1" href="cinema.jsp">Reset filters</a>
<% } else {
	%>
<h2>Cinemass <img border="0"  src="img/cinema.png" width="20" height="20"></h2>
<div class="parent">
	<% 

...
<div class="signupf">
<form action="MuseumSearch" id="ex" method="post" onsubmit="return sform(this)">
	...
	<a class="b5" href="museum.jsp">Reset filters</a>
</form>
</div>
<div class="data">
<%
...
%>
<h2>No results found</h2> <a class="b1" href="museum.jsp">Reset filters</a>
<% } else {
	%>
<h2>Museums <img border="0"  src="img/museum.png" width="20" height="20"></h2>
<div class="parent">
	<% 

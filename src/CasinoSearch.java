...
@WebServlet(urlPatterns = {"/CasinoSearch"})
public class CasinoSearch extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    	...
    	String nam=request.getParameter("nm");
       	...
       	String o="";
       	if(!oh.equals("Anytime")){
       		int val=Integer.parseInt(oh);
       		o="FILTER ( ?openingHours = "+val+" ) .";
       	}
       	else {
       		count++;
       	}
    	...
    	in.close();
    	response.sendRedirect("casinop.jsp");
